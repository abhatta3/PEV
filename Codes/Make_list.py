...
def print_help():
    print 'python ./Codes/Make_list.py -i <input event file> -o <outputfile (PSMs)> -d <database search file (from ENOSI/MSGF+...)>'
    print 'Optional arguments [For following column numbers the first column number is 0]:'
    print '-a : column number for spectrum file name in database search file; default 0'
    print '-b : column number for spectrum index number in database search file; default 1'
    print '-c : column number for reported peptide in database search file; default 8'
